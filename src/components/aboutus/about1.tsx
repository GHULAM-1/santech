  ...
  return (
    <>
            ...
            <div className='flex flex-col md:flex-row gap-[20px] '>
              <div className='lg:w-[847px] lg:h-[400px] w-[272px] h-[120px]'>
                <img className=' ' src="/about/about2.png" alt="" />
                </div>
                <div className='lg:w-[413px] lg:h-[400px] h-[400px] w-[272px] object-cover  '>
                <img className='' src="/about/about1.png" alt="" />
                </div>
            </div>
