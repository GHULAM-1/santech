  ...
  return (
    <>
            ...
            <div className='flex flex-col md:flex-row gap-[20px] '>
              <div className=''>
                <img className=' lg:w-[847px] lg:h-[400px] rounded-[8px] w-[272px] h-[120px] md:w-[419px] md:h-[200px] object-cover' src="/about/about2.png" alt="" />
                </div>
                <div className=' '>
                <img className='lg:w-[413px] lg:h-[400px] rounded-[8px] md:h-[200px] md:w-[241px] xl:h-[400px] h-[120px] w-[272px] object-cover ' src="/about/about1.png" alt="" />
                </div>
            </div>
