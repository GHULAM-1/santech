...
const pillsVariants = cva(
  "flex flex-row justify-center items-center gap-2 outline-none px-4", // Added px-4 here
  {
    variants: {
      intent: {
        cta: "bg-themeColor",
      ...
      size: {
        regularFilterPills:
          "SMALL_LAPTOP:text-SMALL_LAPTOP-Text TABLET:text-Tablet-Small-Text text-SMALL_LAPTOP-SS-Text py-[0.25rem] px-[0.9rem] rounded-[1rem] TABLET:px-[1.5rem] TABLET:py-[0.5rem] TABLET:rounded-[2rem] whitespace-nowrap",
        blogTags:
