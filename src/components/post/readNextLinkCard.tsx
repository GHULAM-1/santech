  ...
  return (
    <>
      <a
        ...
        className="text-Mobile-Head TABLET:text-Tablet-Large-Text flex items-end TABLET:max-w-[338px] max-w-[250px] justify-between border border-red-700"
      >
        <div className=" leading-[4rem] max-w-[200px] TABLET:max-w-[260px]">
          <span className=" border-b-2 border-textPrimaryColor text-black pb-[6px]   ">
            {linkHeading}
          </span>
        </div>
